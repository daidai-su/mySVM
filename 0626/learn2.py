...
class App:
    def __init__(self, master):
        ...
        self.canvas.grid(row=0, column=0, columnspan=3, pady=(10, 5), padx=10)

        # --- ラベルと入力 ---
        tk.Label(master, text="Correct Digit:", font=FONT_MEDIUM, bg="#f0f0f0").grid(row=1, column=0, sticky=tk.E)
        self.entry = tk.Entry(master, width=5, font=FONT_LARGE, justify='center')
        self.entry.grid(row=1, column=1, sticky=tk.W)

        # --- Save ボタン ---
        self.save_button = tk.Button(master, text="Save", command=self.save_digit,
                                    bg='white', fg='black', font=FONT_SMALL, relief=tk.GROOVE)
        ...
        self.predict_button = tk.Button(master, text="Predict", command=self.predict,
                                     bg='white', fg='black', font=FONT_MEDIUM,
        ...
        self.clear_button = tk.Button(master, text="Clear", command=self.clear,
                                    bg='white', fg='black', font=FONT_MEDIUM, relief=tk.GROOVE)
        ...
        self.train_button = tk.Button(master, text="Train", command=self.train_model,
                                    bg='white', fg='black', font=FONT_LARGE, relief=tk.GROOVE)
        self.train_button.grid(row=4, column=0, columnspan=3, pady=(5, 15), padx=10, sticky=tk.W+tk.E)

        # --- ステータスラベル ---
        self.label = tk.Label(master, text="Starting up...", font=FONT_MEDIUM, bg="#f0f0f0")
    ...
    def train_model(self):
        ...
        self.predict_button.config(state=tk.NORMAL)  # 予測ボタンを有効化
